...
<body>
    ...
    <div class="container">
        ...
        <div class="welcome">
            <h3>Welcome to </h3>
            <h1>The Cooldudes Foundation Bank</h1>
        </div>
        ...
        <div class="allbtns">
            ...
            <!-- Add this line to the allbtns div -->
            <a href="loan.php"><button type="button"><i class="fas fa-hand-holding-usd"></i> GIVE LOAN &nbsp;&nbsp;&nbsp; </button></a>
        </div>
